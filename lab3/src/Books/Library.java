    ...
    public Library() {
        ...
        for (int i = 0; i < 30; i++) {
            ...
            for(int j=0; j<4; j++){
                ...
                currencyPrice.put("PLN", randomPrice);
                currencyPrice.put("USD", randomPrice / 3.7966);
                currencyPrice.put("EUR", randomPrice / 4.2978);
                currencyPrice.put("RUB", randomPrice / 0.0591);
                currencyPrice.put("JPY", randomPrice / 0.034446);
            }
